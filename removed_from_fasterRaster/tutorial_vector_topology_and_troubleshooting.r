...
#'
#' There are other properties involving combinations of lines and polygons in the same vector, but **fasterRaster** does not allow shapes of different types in the same vector. Topological issues generally arise only with polygon vectors, not point or line vectors.
#' 
